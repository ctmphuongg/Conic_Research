...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_3 = Integer(3); _sage_const_583421287793 = Integer(583421287793); _sage_const_12762 = Integer(12762)
...
def pell_method(NN, B):
    ...
    while True:
        ...
        d = ((a**_sage_const_2 -_sage_const_1 ) * b_inv) % NN
        if d % _sage_const_4  == _sage_const_2  or d % _sage_const_4  == _sage_const_3 :
            break
    d = R(d)    
    xN, yN = R(a), R(b)
    # print(f"(x,y) = ({xN},{yN})")
